  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 lg:gap-10 mt-7">
          <InfoCard Icon={rating} text="4.9 Customer Rating" />
          <InfoCard Icon={free} text="Completely Free" />
          <InfoCard Icon={reminder} text="Reminders and Alerts" />
          <InfoCard Icon={notification} text="Push Notifications" />
        </div>
      </div>
