...
const Benefits = ({ refs }) => {
  ...
  return (
    <div className="mt-12 flex flex-col items-center justify-center p-3" ref={refs.benefitsRef}>
      <p className="md:text-3xl text-2xl mt-5 font-medium text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-8 gap-x-2 mt-10 md:mt-16 lg:px-16">
