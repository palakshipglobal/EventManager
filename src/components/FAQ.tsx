...
const FAQ = () => {
  ...
  return (
    <div className="p-3 md:p-6 lg:px-24 mt-14 md:mt-20">
      <div className="grid md:grid-cols-2 grid-cols-1 shadow-xl md:py-5 md:px-14 rounded-lg md:gap-16 lg:gap-24 gap-10">
